...
<head>
    ...
    <meta charset="utf-8" />
    <title>PR365 Backend - @yield('title')</title>
                ...
                <div class="header-inner">
                    <div class="brand inline">
                        ...
                        <ul class="notification-list list-inline">
                            <li><a href="{{ url('/home') }}"><i class="fs-14 pg-home"></i></a></li>
                            <li><a href="{{ url('/facilities') }}">Facilities</a></li>
                            <li><a href="{{ route('contact.index') }}">Contact Us</a></li>
                            <li><a href="{{ url('/facilitymap') }}">Facility Map</a></li>
            ...
            <div class="pull-right">
                ...
                <div class="visible-lg visible-md m-t-10">
                    <div class="pull-left p-r-10 p-t-10 fs-16 font-heading">
                        <span class="semi-bold">{!! Auth::user()->firstname !!}</span> <span class="text-master"></span>
                    </div>
